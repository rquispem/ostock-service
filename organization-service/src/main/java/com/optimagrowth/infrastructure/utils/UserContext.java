...
public class UserContext {
  ...
  /*
   * Defining our variables as ThreadLocal lets us store data individually for the current thread. The information
   * set here can only be read by the thread that set the value.
   */
